                                ...
                                <div className="owl-carousel owl-theme" id="sync1">
                                    <div className="item">
                                        <div className="testimonials-one__single"
                                            ...
                                            <p className="testimonials-one__text">This is due to their excellent
                                                service, competitive
                                                pricing and customer support. It’s throughly refresing to get such a
                                                personal touch.
                                                Duis aute irure dolor in reprehenderit in voluptate velit esse cillum eu
                                                fugiat
                                                nulla pariatur.</p>
